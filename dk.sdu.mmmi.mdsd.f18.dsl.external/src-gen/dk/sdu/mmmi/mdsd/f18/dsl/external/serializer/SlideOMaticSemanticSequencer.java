...
public class SlideOMaticSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SlideOMaticPackage.eINSTANCE)
			...
			case SlideOMaticPackage.ANIMATION:
				if (rule == grammarAccess.getAnimationRule()) {
					sequence_Animation(context, (Animation) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getContentRule()) {
					sequence_Animation_Content(context, (Animation) semanticObject); 
					return; 
				}
				else break;
			...
			case SlideOMaticPackage.BOLD:
				sequence_TextType(context, (Bold) semanticObject); 
				return; 
			...
			case SlideOMaticPackage.FOOT_NOTE:
				sequence_TextType(context, (FootNote) semanticObject); 
				return; 
			...
			case SlideOMaticPackage.ITALIC:
				sequence_TextType(context, (Italic) semanticObject); 
				return; 
			...
			case SlideOMaticPackage.SEC:
				...
				return; 
			case SlideOMaticPackage.SHOW_IMAGE:
				if (rule == grammarAccess.getContentRule()) {
					sequence_Content_ShowImage(context, (ShowImage) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getShowImageRule()) {
					sequence_ShowImage(context, (ShowImage) semanticObject); 
					return; 
				}
				else break;
			...
			case SlideOMaticPackage.URL:
				sequence_TextType(context, (URL) semanticObject); 
				return; 
			...
			case SlideOMaticPackage.UNDERLINE:
				sequence_TextType(context, (Underline) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (target=[Image|ID] fromLocation=Alignment finalLocation=Alignment viaLocation=Alignment?)
	 */
	...
	/**
	 * Contexts:
	 *     Content returns Animation
	 *
	 * Constraint:
	 *     (target=[Image|ID] fromLocation=Alignment finalLocation=Alignment viaLocation=Alignment? click=Click?)
	 */
	protected void sequence_Animation_Content(ISerializationContext context, Animation semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     Content returns ShowImage
	 *
	 * Constraint:
	 *     (image=[Image|ID] click=Click?)
	 */
	protected void sequence_Content_ShowImage(ISerializationContext context, ShowImage semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (types+=TextType* text=STRING click=Click?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID src=STRING angle=INT? alignment=Alignment? size=Size)
	 */
	...
	/**
	 * Contexts:
	 *     ShowImage returns ShowImage
	 *
	 * Constraint:
	 *     image=[Image|ID]
	 */
	protected void sequence_ShowImage(ISerializationContext context, ShowImage semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SlideOMaticPackage.Literals.SHOW_IMAGE__IMAGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SlideOMaticPackage.Literals.SHOW_IMAGE__IMAGE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getShowImageAccess().getImageImageIDTerminalRuleCall_1_0_1(), semanticObject.eGet(SlideOMaticPackage.Literals.SHOW_IMAGE__IMAGE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (way=Way size=INT (unit='cm' | unit='em' | unit='mm'))
	 */
	...
	protected void sequence_Size(ISerializationContext context, ProportionalSize semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SlideOMaticPackage.Literals.SIZE__WAY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SlideOMaticPackage.Literals.SIZE__WAY));
	...
	/**
	 * Contexts:
	 *     TextType returns Bold
	 *
	 * Constraint:
	 *     {Bold}
	 */
	protected void sequence_TextType(ISerializationContext context, Bold semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     TextType returns FootNote
	 *
	 * Constraint:
	 *     {FootNote}
	 */
	protected void sequence_TextType(ISerializationContext context, FootNote semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     TextType returns Italic
	 *
	 * Constraint:
	 *     {Italic}
	 */
	protected void sequence_TextType(ISerializationContext context, Italic semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     TextType returns URL
	 *
	 * Constraint:
	 *     {URL}
	 */
	protected void sequence_TextType(ISerializationContext context, URL semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     TextType returns Underline
	 *
	 * Constraint:
	 *     {Underline}
	 */
	protected void sequence_TextType(ISerializationContext context, Underline semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
