...
public class SlideOMaticSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        ShowImage showImage = (ShowImage)theEObject;
        T result = caseShowImage(showImage);
        if (result == null) result = caseContent(showImage);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case SlideOMaticPackage.ANIMATION:
      {
        ...
        if (result == null) result = caseContent(animation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Show Image</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Show Image</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseShowImage(ShowImage object)
  {
    return null;
  }
