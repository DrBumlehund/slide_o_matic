...
public class SlideOMaticPackageImpl extends EPackageImpl implements SlideOMaticPackage
{
   ...
   * @generated
   */
  private EClass showImageEClass = null;
   ...
   * @generated
   */
  public EReference getPresentation_Images()
  {
   ...
   * @generated
   */
  public EAttribute getImage_Angle()
  {
   ...
   * @generated
   */
  public EClass getShowImage()
  {
    return showImageEClass;
  }
   ...
   * @generated
   */
  public EReference getShowImage_Image()
  {
    return (EReference)showImageEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getAnimation_FromLocation()
  {
   ...
   * @generated
   */
  public EAttribute getAnimation_FinalLocation()
  {
   ...
   * @generated
   */
  public EAttribute getAnimation_ViaLocation()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(presentationEClass, PRESENTATION__IMAGES);
    ...
    createEAttribute(imageEClass, IMAGE__ANGLE);
    createEAttribute(imageEClass, IMAGE__ALIGNMENT);
    createEReference(imageEClass, IMAGE__SIZE);

    showImageEClass = createEClass(SHOW_IMAGE);
    createEReference(showImageEClass, SHOW_IMAGE__IMAGE);
    ...
    createEAttribute(animationEClass, ANIMATION__FROM_LOCATION);
    createEAttribute(animationEClass, ANIMATION__FINAL_LOCATION);
    createEAttribute(animationEClass, ANIMATION__VIA_LOCATION);
  ...
  public void initializePackageContents()
  {
    ...
    showImageEClass.getESuperTypes().add(this.getContent());
    tableEClass.getESuperTypes().add(this.getContent());
    codeEClass.getESuperTypes().add(this.getContent());
    animationEClass.getESuperTypes().add(this.getContent());
    ...
    initEReference(getPresentation_Images(), this.getImage(), null, "images", null, 0, -1, Presentation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getImage_Angle(), ecorePackage.getEInt(), "angle", null, 0, 1, Image.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(showImageEClass, ShowImage.class, "ShowImage", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getShowImage_Image(), this.getImage(), null, "image", null, 0, 1, ShowImage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAnimation_FromLocation(), ecorePackage.getEString(), "fromLocation", null, 0, 1, Animation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAnimation_FinalLocation(), ecorePackage.getEString(), "finalLocation", null, 0, 1, Animation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAnimation_ViaLocation(), ecorePackage.getEString(), "viaLocation", null, 0, 1, Animation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
