 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.f18.dsl.external.slideOMatic.impl.ImageImpl#getAngle <em>Angle</em>}</li>
...
public class ImageImpl extends MinimalEObjectImpl.Container implements Image
{
  ...
  public void setAngle(int newAngle)
  {
    ...
    angle = newAngle;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SlideOMaticPackage.IMAGE__ANGLE, oldAngle, angle));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SlideOMaticPackage.IMAGE__SRC:
        return getSrc();
      case SlideOMaticPackage.IMAGE__ANGLE:
        return getAngle();
